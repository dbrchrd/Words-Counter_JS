...
const main = () => {
  ...
  const strHandling = () => {
    ...
    text_area_str_filt = text_area_str.filter(word => word.length > 0 && word != "  "  && word != "." && word != ";" && word != ":" && word != "!" && word != "?" && word != "," && word != "-" && word != "–" && word != "–" && word != "—" && word != "«" && word != "»" && word != "/" && word != "’" && word != "…" && word != ".." && word != "..." && word != "(" && word != ")" && word != "[" && word != "]");
  }
